...
NSE_MIDCAP_SMALLCAP = [
    # Midcap stocks
    "AADHARHFC.NS", "AAKASH.NS", "AAPL.NS", "AARTISURF.NS", "AAVAS.NS",
    "ABMINTLTD.NS", "ACCELYA.NS", "ACE.NS", "ADANIENSOL.NS", "ADANIPOWER.NS",
    "ADORWELD.NS", "ADVANIHOTR.NS", "ADVENZYMES.NS", "AEGISCHEM.NS", "AETHER.NS",
    "AGARIND.NS", "AGROPHOS.NS", "AHLUCONT.NS", "AIAENG.NS", "AJMERA.NS",
    "ALEMBICLTD.NS", "ALKEM.NS", "ALLCARGO.NS", "AMARAJABAT.NS", "AMBER.NS",
    "AMIORG.NS", "AMRUTANJAN.NS", "ANANTRAJ.NS", "ANDHRAPET.NS", "ANGELONE.NS",
    "ANURAS.NS", "APCOTEXIND.NS", "APLAPOLLO.NS", "APLLTD.NS", "ARCHIDPLY.NS",
    "ARVINDFASN.NS", "ARVIND.NS", "ASAHISONG.NS", "ASHIANA.NS", "ASHOKA.NS",
    "ASIANHOTNR.NS", "ASTERDM.NS", "ASTRAMICRO.NS", "ASTRAZEN.NS", "ATFL.NS",
    "ATUL.NS", "AURIONPRO.NS", "AUTOAXLES.NS", "AVTNPL.NS", "AXISCADES.NS",
    # Banking and finance (additional)
    "BAJAJHIND.NS", "BALAMINES.NS", "BALMLAWRIE.NS", "BANARISUG.NS", "BANCOINDIA.NS",
    "BANKINDIA.NS", "BARBEQUE.NS", "BASF.NS", "BATAINDIA.NS", "BBTC.NS",
    "BDL.NS", "BEL.NS", "BEPL.NS", "BFUTILITIE.NS", "BLS.NS",
    "BLUESTARCO.NS", "BODALCHEM.NS", "BOROLTD.NS", "BORORENEW.NS", "BOSCHLTD.NS",
    "BPCL.NS", "BRFL.NS", "BSHSL.NS", "BURNPUR.NS", "BUTTERFLY.NS",
    # Capital goods
    ...
    "CEATLTD.NS", "CENTURYTEX.NS", "CENTURYPLY.NS", "CERA.NS", "CESC.NS",
    "CGCL.NS", "CGPOWER.NS", "CHALET.NS", "CHAMBLFERT.NS", "CHEMCON.NS",
    "CHENNPETRO.NS", "CHEVIOT.NS", "CHOICEIN.NS", "CIGNITI.NS", "CINELINE.NS",
    "CINEVISTA.NS", "CITYNEON.NS", "CLEAN.NS", "CLSEL.NS", "COALINDIA.NS",
    # Consumer goods
    "COCHINSHIP.NS", "COLPAL.NS", "CONFIPET.NS", "CONTROLPR.NS", "COROMANDEL.NS",
    "COSMOFILMS.NS", "CRAFTSMAN.NS", "CREATIVE.NS", "CRISIL.NS", "CSBBANK.NS",
    "CUB.NS", "CYIENT.NS", "CYIENTDLM.NS", "DAAWAT.NS", "DABUR.NS",
    "DALMIASUG.NS", "DATAMATICS.NS", "DATAPATTNS.NS", "DBCORP.NS", "DBREALTY.NS",
    "DCAL.NS", "DCM.NS", "DCMSHRIRAM.NS", "DCW.NS", "DECCANCE.NS",
    # Diversified
    "DEEPAKFERT.NS", "DEEPAKNTR.NS", "DELTACORP.NS", "DENORA.NS", "DFMFOODS.NS",
    "DGCONTENT.NS", "DHAMPURE.NS", "DHANI.NS", "DHARAMSI.NS", "DHRUV.NS",
    "DIAMONDYD.NS", "DICIND.NS", "DIXON.NS", "DLF.NS", "DMART.NS",
    "DOLLAR.NS", "DOMIND.NS", "DONEAR.NS", "DPABHUSHAN.NS", "DPSCLTD.NS",
    "DRREDDY.NS", "DSSL.NS", "DTIL.NS", "DUCON.NS", "DWARKESH.NS",
    # Engineering
    "DYNAMATECH.NS", "DYNPRO.NS", "EASEMYTRIP.NS", "ECLERX.NS", "EDELWEISS.NS",
    "EICHERMOT.NS", "EIDPARRY.NS", "EIHAHOTELS.NS", "EIHOTEL.NS", "ELECTCAST.NS",
    "ELECON.NS", "ELGIEQUIP.NS", "EMAMILTD.NS", "EMKAY.NS", "EMMBI.NS",
    "ENDURANCE.NS", "ENGINERSIN.NS", "ENIL.NS", "EPL.NS", "EQUITAS.NS",
    "EQUITASBNK.NS", "EROSMEDIA.NS", "ESABINDIA.NS", "ESCORTS.NS", "ESSARSHPNG.NS",
    # Financial services
    "ETHOSLTD.NS", "EUROLIFEHI.NS", "EVERESTIND.NS", "EXCELINDUS.NS", "EXIDEIND.NS",
    "FACT.NS", "FAIRCHEM.NS", "FDC.NS", "FEDERALBNK.NS", "FIEM.NS",
    "FILATEX.NS", "FINCABLES.NS", "FINPIPE.NS", "FIRSTCRY.NS", "FLEMINGO.NS",
    "FLOURMILL.NS", "FLFL.NS", "FMGOETZE.NS", "FNOXCHEM.NS", "FORCEMOT.NS",
    "FORTUNE.NS", "FOSECOIND.NS", "FRETAIL.NS", "FSL.NS", "GABRIEL.NS",
    # Healthcare
    "GAEL.NS", "GAIL.NS", "GALAXYSURF.NS", "GALLANTT.NS", "GANDHAR.NS",
    "GANDHITUBE.NS", "GANECOS.NS", "GANESHBE.NS", "GANESHHOUC.NS", "GANGAFORGE.NS",
    "GARFIBRES.NS", "GATEWAY.NS", "GAYAPROJ.NS", "GDL.NS", "GEECEE.NS",
    "GENCON.NS", "GENESYS.NS", "GENUSPOWER.NS", "GESHIP.NS", "GET&D.NS",
    "GHCL.NS", "GICHSGFIN.NS", "GILLETTE.NS", "GIPCL.NS", "GLAND.NS",
    # Industrial
    ...
    "GODREJIND.NS", "GODREJPROP.NS", "GOKEX.NS", "GOKUL.NS", "GOKULAGRO.NS",
    "GOLDIAM.NS", "GOLDENTOBC.NS", "GOODLUCK.NS", "GOODYEAR.NS", "GPIL.NS",
    "GPPL.NS", "GRANULES.NS", "GRAPHITE.NS", "GRASIM.NS", "GRAVITA.NS",
    # IT and tech
    "GREENLAM.NS", "GREENPLY.NS", "GRINDWELL.NS", "GRMOVER.NS", "GROBTEA.NS",
    "GRPLTD.NS", "GRSE.NS", "GSFC.NS", "GSPL.NS", "GTL.NS",
    "GTLINFRA.NS", "GUFICBIO.NS", "GUJALKALI.NS", "GUJAPOLLO.NS", "GUJGASLTD.NS",
    "GUJRAFFIA.NS", "GULFOILLUB.NS", "GULPOLY.NS", "GVKPIL.NS", "HAL.NS",
    "HAPPSTMNDS.NS", "HARDWYN.NS", "HARIOMPIPE.NS", "HARRMALAYA.NS", "HATHWAY.NS",
    # Metals and mining
    "HATSUN.NS", "HAVELLS.NS", "HAVISHA.NS", "HBL.NS", "HBLPOWER.NS",
    "HCC.NS", "HCL-INSYS.NS", "HCLTECH.NS", "HDFCAMC.NS", "HDFCBANK.NS",
    "HDFCLIFE.NS", "HDIL.NS", "HEG.NS", "HEIDELBERG.NS", "HERCULES.NS",
    "HERITGFOOD.NS", "HEROMOTOCO.NS", "HESTERBIO.NS", "HEXAWARE.NS", "HFCL.NS",
    "HGINFRA.NS", "HIKAL.NS", "HIL.NS", "HILTON.NS", "HIMATSEIDE.NS",
    # Pharma
    "HINDALCO.NS", "HINDCOPPER.NS", "HINDMOTORS.NS", "HINDNATGLS.NS", "HINDOILEXP.NS",
    "HINDPETRO.NS", "HINDUNILVR.NS", "HINDZINC.NS", "HIRECT.NS", "HISARMETAL.NS",
    "HITECH.NS", "HITECHCORP.NS", "HLEGLAS.NS", "HMVL.NS", "HNDFDS.NS",
    "HOMEFIRST.NS", "HONAUT.NS", "HONDAPOWER.NS", "HOVS.NS", "HSCL.NS",
    "HTMEDIA.NS", "HUDCO.NS", "IBREALEST.NS", "IBULHSGFIN.NS", "ICICIBANK.NS",
    # Real estate
    "ICICIGI.NS", "ICICIPRULI.NS", "ICRA.NS", "IDBI.NS", "IDEA.NS",
    "IDFC.NS", "IDFCFIRSTB.NS", "IEX.NS", "IFBAGRO.NS", "IFBIND.NS",
    "IFCI.NS", "IFGLEXPOR.NS", "IGARASHI.NS", "IGPL.NS", "IIFL.NS",
    "IIFLSEC.NS", "IIFLWAM.NS", "IMAGICAA.NS", "IMFA.NS", "IMPAL.NS",
    "INCREDIBLE.NS", "INDIACEM.NS", "INDIAGLYCO.NS", "INDIAHOME.NS", "INDIAMART.NS",
    # Telecom
    "INDIANB.NS", "INDIANHUME.NS", "INDIGO.NS", "INDIGOPNTS.NS", "INDNIPPON.NS",
    "INDOCO.NS", "INDORAMA.NS", "INDOSTAR.NS", "INDOWIND.NS", "INDRAMEDCO.NS",
    "INDSWFTLAB.NS", "INDSWFTLTD.NS", "INDUSTOWER.NS", "INFIBEAM.NS", "INFOMEDIA.NS",
    "INFY.NS", "INGERRAND.NS", "INOXGREEN.NS", "INOXWIND.NS", "INSECTICID.NS",
    "INTELLECT.NS", "INTENTECH.NS", "IOB.NS", "IOC.NS", "IOLCP.NS",
    # Textiles
    "IONEXCHANG.NS", "IPCALAB.NS", "IRB.NS", "IRCON.NS", "IRCTC.NS",
    "IRFC.NS", "IRIS.NS", "ISEC.NS", "ISGEC.NS", "ISFT.NS",
    "ITDCEM.NS", "ITDC.NS", "ITI.NS", "IVC.NS", "IZMO.NS",
    "JISLJALEQS.NS", "JKCEMENT.NS", "JKIL.NS", "JKLAKSHMI.NS", "JKPAPER.NS",
    "JKTYRE.NS", "JMFINANCIL.NS", "JOCIL.NS", "JPASSOCIAT.NS", "JSL.NS",
    # Utilities
    "JSLHISAR.NS", "JSWENERGY.NS", "JSWHL.NS", "JSWINFRA.NS", "JSWSTEEL.NS",
    "JTEKTINDIA.NS", "JTLIND.NS", "JUBLFOOD.NS", "JUBLINDS.NS", "JUBLPHARMA.NS",
    "JUSTDIAL.NS", "JYOTHYLAB.NS", "KABRAEXTRU.NS", "KAJARIACER.NS", "KAKATCEM.NS",
    "KALPATPOWR.NS", "KALYANKJIL.NS", "KAMATHOTEL.NS", "KAMDHENU.NS", "KANANIIND.NS",
    "KANDARP.NS", "KANORICHEM.NS", "KANSAINER.NS", "KAPSTON.NS", "KARMAENG.NS",
    # Additional stocks
    "KARNA.NS", "KARUR.NS", "KAVVERITEL.NS", "KAYA.NS", "KAYNES.NS",
    "KDDL.NS", "KEC.NS", "KECL.NS", "KEI.NS", "KELLTONTEC.NS",
    "KENNAMET.NS", "KESORAMIND.NS", "KEYFINSERV.NS", "KFIN.NS", "KHADIM.NS",
    "KHAITAN.NS", "KILITCH.NS", "KINGFA.NS", "KIOCL.NS", "KIRIINDUS.NS",
    "KIRLOSENG.NS", "KIRLOSIND.NS", "KITEX.NS", "KKCL.NS", "KNRCON.NS",
    "KOKUYOCMLN.NS", "KOLTEPATIL.NS", "KOPRAN.NS", "KOTAKBANK.NS", "KOTARISUG.NS",
    "KPIGREEN.NS", "KPIL.NS", "KPITTECH.NS", "KRBL.NS", "KRIDHANINF.NS",
    "KSB.NS", "KSCL.NS", "KTKBANK.NS", "KUANTUM.NS", "L&TFH.NS",
    "LALPATHLAB.NS", "LAOPALA.NS", "LATENTVIEW.NS", "LAURUSLABS.NS", "LAXMIMACH.NS",
    "LEMONTREE.NS", "LGBBROSLTD.NS", "LIBERTSHOE.NS", "LICHSGFIN.NS", "LIKHITHA.NS",
    "LINCOLN.NS", "LINDEINDIA.NS", "LLOYDSME.NS", "LSIL.NS", "LT.NS",
    "LTF.NS", "LTFOODS.NS", "LTIM.NS", "LTTS.NS", "LUMAXIND.NS",
    "LUMAXTECH.NS", "LUPIN.NS", "LUXIND.NS", "LXCHEM.NS", "LYKALABS.NS",
]

# BSE-specific stocks (stocks primarily traded on BSE)
BSE_ADDITIONAL = [
    "500002.BO", "500003.BO", "500008.BO", "500010.BO", "500012.BO",
    "500013.BO", "500020.BO", "500023.BO", "500024.BO", "500027.BO",
    "500028.BO", "500031.BO", "500032.BO", "500033.BO", "500034.BO",
    "500038.BO", "500039.BO", "500040.BO", "500042.BO", "500043.BO",
    "500049.BO", "500052.BO", "500055.BO", "500056.BO", "500057.BO",
    "500058.BO", "500060.BO", "500063.BO", "500067.BO", "500069.BO",
    "500070.BO", "500072.BO", "500074.BO", "500075.BO", "500077.BO",
    "500078.BO", "500079.BO", "500080.BO", "500081.BO", "500082.BO",
    "500083.BO", "500084.BO", "500085.BO", "500086.BO", "500087.BO",
    # Common BSE stocks with names
...
NSE_SMALLCAP_EXTRA = [
    "MAANALU.NS", "MADHAV.NS", "MADHUCON.NS", "MADRASFERT.NS", "MAGADSUGAR.NS",
    "MAGNUM.NS", "MAHABANK.NS", "MAHAPEXLTD.NS", "MAHARASHTRA.NS", "MAHASTEEL.NS",
    "MAHINDCIE.NS", "MAHLOG.NS", "MAHSEAMLES.NS", "MAITHANALL.NS", "MAJESCO.NS",
    "MAKTAAOP.NS", "MALUPAPER.NS", "MANAKALUCO.NS", "MANAKCOAT.NS", "MANAKSIA.NS",
    "MANAKSTEEL.NS", "MANALIPETC.NS", "MANAPPURAM.NS", "MANGALAM.NS", "MANGCHEFER.NS",
    "MANGLMCEM.NS", "MANGTIMBER.NS", "MANINDS.NS", "MANINFRA.NS", "MANKIND.NS",
    "MANORAMA.NS", "MANORG.NS", "MANPASAND.NS", "MARATHON.NS", "MARKSANS.NS",
    "MASFIN.NS", "MASTEK.NS", "MATRIMONY.NS", "MAXHEALTH.NS", "MAXIND.NS",
    "MAYURUNIQ.NS", "MAZDA.NS", "MAZDOCK.NS", "MBAPL.NS", "MBECL.NS",
    "MBLINFRA.NS", "MCDOWELL-N.NS", "MCX.NS", "MEDANTA.NS", "MEDICAMEQ.NS",
    "MEDPLUS.NS", "MEGASOFT.NS", "MEGH.NS", "MELSTAR.NS", "MENONBE.NS",
    "MENON.NS", "MERCATOR.NS", "MERCURY.NS", "METALFORGE.NS", "METROBRAND.NS",
    "METROPOLIS.NS", "MFL.NS", "MFSL.NS", "MGL.NS", "MGMHCARE.NS",
    "MHRIL.NS", "MHHL.NS", "MIDHANI.NS", "MINDACORP.NS", "MINDAIND.NS",
    "MINDTECK.NS", "MIRCELECTR.NS", "MIRZAINT.NS", "MITCON.NS", "MITTAL.NS",
    "MKPL.NS", "MMFL.NS", "MMTC.NS", "MODIRUBBER.NS", "MODISONLTD.NS",
    "MOFL.NS", "MOIL.NS", "MOL.NS", "MOLDTECH.NS", "MOLDTKPAC.NS",
    "MONARCH.NS", "MOREPENLAB.NS", "MOTHERSON.NS", "MOTILALOFS.NS", "MOTOGENFIN.NS",
    "MPHASIS.NS", "MPSLTD.NS", "MRF.NS", "MRO-TEK.NS", "MRPL.NS",
    "MSPL.NS", "MSTCLTD.NS", "MTEDUCARE.NS", "MTLPROMO.NS", "MTNL.NS",
    "MUKANDLTD.NS", "MUKTAARTS.NS", "MUNJALAU.NS", "MUNJALSHOW.NS", "MURUDCERA.NS",
    "MURUDESHWA.NS", "MUTHOOTCAP.NS", "MUTHOOTFIN.NS", "MVL.NS", "NACLIND.NS",
    "NAGREEKCAP.NS", "NAGREEKCAP.NS", "NAM-INDIA.NS", "NARAYANA.NS", "NATCOPHARM.NS",
    "NATHBIOGEN.NS", "NATIONALUM.NS", "NAUKRI.NS", "NAVINFLUOR.NS", "NAVKARCORP.NS",
    "NAVNETEDUL.NS", "NBCC.NS", "NBIFIN.NS", "NBVENTURES.NS", "NCC.NS",
    "NCLIND.NS", "NDGL.NS", "NDL.NS", "NDTV.NS", "NECLIFE.NS",
    "NEELAML.NS", "NELCAST.NS", "NELCO.NS", "NEOGEN.NS", "NESCO.NS",
    "NESTLEIND.NS", "NETWORK18.NS", "NEULANDLAB.NS", "NEWGEN.NS", "NEXTMEDIA.NS",
    "NFL.NS", "NGIL.NS", "NHPC.NS", "NIACL.NS", "NIBL.NS",
    "NIELIT.NS", "NIITLTD.NS", "NIITTECH.NS", "NILAINFRA.NS", "NILKAMAL.NS",
    "NIPPOBATRY.NS", "NLCINDIA.NS", "NMDC.NS", "NOCIL.NS", "NOIDATOLL.NS",
    "NORTHARC.NS", "NRAIL.NS", "NRBBEARING.NS", "NSIL.NS", "NSLNISP.NS",
    "NTPC.NS", "NUCLEUS.NS", "NURECA.NS", "OBEROIRLTY.NS", "OCCL.NS",
    "OFSS.NS", "OIL.NS", "OLECTRA.NS", "OMAXAUTO.NS", "OMAXE.NS",
    "OMNISCIENT.NS", "ONELIFECA.NS", "ONGC.NS", "ONMOBILE.NS", "ONWARDTEC.NS",
    "OPTOCIRCUI.NS", "ORBTEXP.NS", "ORCHPHARMA.NS", "ORIENTABRA.NS", "ORIENTBELL.NS",
    "ORIENTCEM.NS", "ORIENTELEC.NS", "ORIENTHOT.NS", "ORIENTLTD.NS", "ORIENTPPR.NS",
    "ORISSAMINE.NS", "ORTEL.NS", "OSIAHYPER.NS", "PAGEIND.NS", "PAISALO.NS",
    "PALASHSEC.NS", "PALREDTEC.NS", "PANACEABIO.NS", "PANIND.NS", "PANORAMUNI.NS",
    "PARACABLES.NS", "PARAGMILK.NS", "PARSVNATH.NS", "PASUPATI.NS", "PATANJALI.NS",
    "PATELENG.NS", "PATINTLOG.NS", "PAUSHAKLTD.NS", "PAYTMLOAN.NS", "PAYTM.NS",
    "PCBL.NS", "PCJEWELLER.NS", "PDMJEPAPER.NS", "PDSL.NS", "PEARLPOLY.NS",
    "PEL.NS", "PENIND.NS", "PENPEBS.NS", "PERSISTENT.NS", "PETRONET.NS",
    "PFC.NS", "PFIZER.NS", "PFOCUS.NS", "PGEL.NS", "PGHH.NS",
    "PGHL.NS", "PHAUSTIN.NS", "PHILIPCARB.NS", "PHOENIXLTD.NS", "PIDILITIND.NS",
    "PIIND.NS", "PILANIINVS.NS", "PILITA.NS", "PIONDIST.NS", "PNBGILTS.NS",
    "PNBHOUSING.NS", "PNB.NS", "PNCINFRA.NS", "PODDAR.NS", "POKARNA.NS",
    "POLICYBZR.NS", "POLYCAB.NS", "POLYLINK.NS", "POLYMAC.NS", "POLYMED.NS",
    "POLYPLEX.NS", "PONNIERODE.NS", "POONAWALLA.NS", "POWERGRID.NS", "POWERMECH.NS",
    "PPLPHARMA.NS", "PPRENT.NS", "PRAJIND.NS", "PRAKASH.NS", "PRAKASHSTL.NS",
    "PRAXIS.NS", "PRECAM.NS", "PRECOT.NS", "PRECWIRE.NS", "PREMEXPLN.NS",
    "PRESSMN.NS", "PRESTIGE.NS", "PRICOLLTD.NS", "PRIMESECU.NS", "PRINCEPIPE.NS",
    "PRISMJOINS.NS", "PRIVISCL.NS", "PROZONINTU.NS", "PRSMJOHNSN.NS", "PSB.NS",
    "PSPPROJECT.NS", "PTC.NS", "PTL.NS", "PUNJABCHEM.NS", "PUNJLLOYD.NS",
    "PURVA.NS", "PVRINOX.NS", "PYXISINDIA.NS", "QUESS.NS", "QUICKHEAL.NS",
    "RADAAN.NS", "RADICO.NS", "RADIOCITY.NS", "RAILTEL.NS", "RAIN.NS",
    "RAJALAKSH.NS", "RAJESHEXPO.NS", "RAJRATAN.NS", "RAJSREESUG.NS", "RAJSREEL.NS",
    "RAJTV.NS", "RALLIS.NS", "RAMACEMEN.NS", "RAMAPHO.NS", "RAMASTEEL.NS",
    "RAMCOCEM.NS", "RAMCOIND.NS", "RAMCOSYS.NS", "RAMKY.NS", "RANASUG.NS",
    "RANEENGINE.NS", "RAPL.NS", "RASHTRIYA.NS", "RATNAMANI.NS", "RAYMOND.NS",
    "RBL.NS", "RBLBANK.NS", "RCOM.NS", "RCF.NS", "RECLTD.NS",
    "REDINGTON.NS", "REFEX.NS", "RELAXO.NS", "RELIANCE.NS", "RELIGARE.NS",
    "REMSONSIND.NS", "RENUKA.NS", "REPCOHOME.NS", "REPRO.NS", "RESPONIND.NS",
    "REVATHI.NS", "RFCL.NS", "RGL.NS", "RHFL.NS", "RICOAUTO.NS",
    "RIIL.NS", "RITES.NS", "RKEC.NS", "RKFORGE.NS", "RMCL.NS",
    "ROHLTD.NS", "ROLEXRINGS.NS", "ROSSELLIND.NS", "ROUTE.NS", "RPGLIFE.NS",
    "RPOWER.NS", "RPPL.NS", "RPPINFRA.NS", "RSWM.NS", "RSYSTEMS.NS",
    "RTNINDIA.NS", "RTNPOWER.NS", "RUBYMILLS.NS", "RUCHI.NS", "RUCHIRA.NS",
    "RUPA.NS", "RUSHIL.NS", "RVNL.NS", "SABAR.NS", "SABTNL.NS",
    "SABEVENTS.NS", "SADBHAV.NS", "SADHANA.NS", "SAFARI.NS", "SAGCEM.NS",
    "SAIL.NS", "SAKAR.NS", "SAKSOFT.NS", "SAKUMA.NS", "SALONA.NS",
    "SALSTEEL.NS", "SALZERELEC.NS", "SAMBHV.NS", "SANGHIIND.NS", "SANGHVIFOR.NS",
    "SANGHVIMOV.NS", "SANGMOVE.NS", "SANOFI.NS", "SANWARIA.NS", "SAPPHIRE.NS",
    "SARDAEN.NS", "SAREGAMA.NS", "SARLAPOLY.NS", "SASKEN.NS", "SATIN.NS",
    "SATINDLTD.NS", "SATRAPROP.NS", "SAURASHCEM.NS", "SAVEN.NS", "SBCL.NS",
    "SBFC.NS", "SBIN.NS", "SBICARD.NS", "SBILIFE.NS", "SCHAEFFLER.NS",
    "SCHNEIDER.NS", "SCPL.NS", "SDB.NS", "SEAMECLTD.NS", "SECL.NS",
    "SECURCRED.NS", "SEJALLTD.NS", "SELAN.NS", "SELMC.NS", "SENCO.NS",
    "SEPC.NS", "SEQUENT.NS", "SESHAPAPER.NS", "SETCO.NS", "SEYAIND.NS",
    "SFL.NS", "SGBFL.NS", "SHAKTIPUMP.NS", "SHALBY.NS", "SHALPAINTS.NS",
    "SHALSTEEL.NS", "SHANKARA.NS", "SHANTIGEAR.NS", "SHARDACROP.NS", "SHARDAMOTR.NS",
    "SHAREINDIA.NS", "SHEMAROO.NS", "SHILPAMED.NS", "SHILPI.NS", "SHIRPUR-G.NS",
]
