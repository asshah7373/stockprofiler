...
NIFTY_50 = [
    ...
    "NESTLEIND.NS", "NTPC.NS", "POWERGRID.NS", "TATAMOTORS.NS", "MAHINDRA.NS",
...
NIFTY_200_EXTRA = [
    ...
    "KANSAINER.NS", "KEI.NS", "KPITTECH.NS", "LTFH.NS", "LAURUSLABS.NS",
    "LICHSGFIN.NS", "LUPIN.NS", "MMFIN.NS", "MANAPPURAM.NS", "MFSL.NS",
    "MGL.NS", "MOTHERSON.NS", "MPHASIS.NS", "MRF.NS", "NAMINDIA.NS",
...
FNO_STOCKS = NIFTY_200 + [
    ...
    "NOCIL.NS", "PIRAMAL.NS", "RBLBANK.NS", "RELAXO.NS", "SOLARINDS.NS",
...
BROAD_MARKET_EXTRA = [
    ...
    "ITI.NS", "JKBANK.NS", "JAMNAAUTO.NS", "JBCHEPHARM.NS", "JINDALSAW.NS",
