...
NIFTY_50 = [
    ...
    "NESTLEIND.NS", "NTPC.NS", "POWERGRID.NS", "TATAMTRDVR.NS", "MM.NS",
...
NIFTY_200_EXTRA = [
    ...
    "BEL.NS", "BHEL.NS", "BIOCON.NS", "BHARATFORG.NS", "CANFINHOME.NS",
    ...
    "GLAND.NS", "GLAXO.NS", "GMRINFRA.NS", "GNFC.NS", "GODREJPROP.NS",
    ...
    "KANSAINER.NS", "KEI.NS", "KPITTECH.NS", "L&TFH.NS", "LAURUSLABS.NS",
    "LICHSGFIN.NS", "LUPIN.NS", "M&MFIN.NS", "MANAPPURAM.NS", "MFSL.NS",
...
FNO_STOCKS = NIFTY_200 + [
    ...
    "COROMANDEL.NS", "DELTACORP.NS", "EMAMILTD.NS", "GLENMARK.NS", "GMRINFRA.NS",
    "GRANULES.NS", "GRAPHITE.NS", "GSFC.NS", "GUJGASLTD.NS", "HINDCOPPER.NS",
    "IBULHSGFIN.NS", "IDFC.NS", "INDHOTEL.NS", "INTELLECT.NS", "IRB.NS",
    "JSWENERGY.NS", "LTTS.NS", "METROPOLIS.NS", "MPHASIS.NS", "NIACL.NS",
    "NOCIL.NS", "PEL.NS", "RBLBANK.NS", "RELAXO.NS", "SOLARINDS.NS",
    "SUMICHEM.NS", "TATAMETALI.NS", "UJJIVAN.NS", "UJJIVANSFB.NS",
]

# Broad market - all major NSE stocks (~500)
BROAD_MARKET_EXTRA = [
    "3MINDIA.NS", "AARTIDRUGS.NS", "AAVAS.NS", "ADANIWILMAR.NS", "AFFLE.NS",
    ...
    "CARERATING.NS", "CASTROLIND.NS", "CEATLTD.NS", "CENTURYTEX.NS", "CENTURYPLY.NS",
    ...
    "HSCL.NS", "HUDCO.NS", "ICRA.NS", "IIFLWAM.NS", "INDIGOPNTS.NS",
    "INDOCO.NS", "INFY.NS", "INOXWIND.NS", "IONEXCHANG.NS", "ISEC.NS",
    "ITI.NS", "J&KBANK.NS", "JAMNAAUTO.NS", "JBCHEPHARM.NS", "JINDALSAW.NS",
    "JKPAPER.NS", "JKTYRE.NS", "JMC.NS", "JSWINFRA.NS", "JTEKTINDIA.NS",
    "JUSTDIAL.NS", "KAJARIACER.NS", "KALPATPOWR.NS", "KALYANKJIL.NS", "KEC.NS",
    "KIOCL.NS", "KNRCON.NS", "KRBL.NS", "KSB.NS", "LATENTVIEW.NS",
    "LAXMIMACH.NS", "LINDEINDIA.NS", "LTF.NS", "LUXIND.NS", "MAHABANK.NS",
    "MAHINDCIE.NS", "MAHLOG.NS", "MAHSEAMLES.NS", "MANINFRA.NS", "MAPMYINDIA.NS",
    ...
    "TEAMLEASE.NS", "TECHNOE.NS", "THYROCARE.NS", "TIMKEN.NS", "TINPLATE.NS",
    "TRITURBINE.NS", "TRVENT.NS", "UCOBANK.NS", "UFLEX.NS", "UTIAMC.NS",
    "VAIBHAVGBL.NS", "VARROC.NS", "VGUARD.NS", "VINATIORGA.NS", "VIPIND.NS",
    "VRLLOG.NS", "VSTIND.NS", "WELCORP.NS", "WELSPUNIND.NS", "WESTLIFE.NS",
    "WPIL.NS", "WOCKPHARMA.NS", "ZENITHSTL.NS", "ZENTEC.NS", "ZFCVINDIA.NS",
]
